    ...
    <div className="py-12 md:py-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          A modern todo list application that helps you manage tasks, track due
          dates, attach reference images, and mark tasks as completed — all in
          one place.
        </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card">
            ...
            <p className="text-gray-600">
              Never miss a deadline with date and time tracking.
            </p>
          </div>
          <div className="card">
            ...
            <p className="text-gray-600">
              Attach images to tasks for better context and clarity.
            </p>
          </div>
        </div>
      </div>
